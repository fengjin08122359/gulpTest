...
//        $(".dialogue-footer").css("bottom",this.adjustHeight)
//      }
  },
    end: function() {
      var m = this;
      ...
      deal: function(type, chatId, json) {
        ...
        if (type == "CUTOMER_IS_INVITED") {
          ...
          if ($messageHide.css("display") != "none") {
            ...
            $messageHide.after("<div class='msg_back_success'>" + dialogue.getAttr("operatorName") + "已撤回一条消息</div>");
...
(function(window, $, undefined) {
  ...
  openCover:function(){
    ...
    showVisitorInfo: function() {
      dialogue.showMsg({
        from: "client",
        content: "<div class='show-visitor-info'> 为了提高我们的服务质量,   请点击<span class = 'spans visitor_info' id = 'v_info'>完善客户信息</span><br></div>",
        saveIn:1
      })
